...
class TestInterventionContext:
    ...
    def test_ctx_fields(self):
        ...
        assert isinstance(retrieved.x_obs_buffer, ObservationBuffer)
        assert isinstance(retrieved.residual_obs_buffer, ObservationBuffer)
